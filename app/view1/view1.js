...
.controller('View1Ctrl', ['$scope','$http',function($scope,$http) {
 /* $scope.products_object=[{"category":"Watersports","description":"A boat for one person","name":"Kayak",
    ...
    {"category":"Chess","description":"Gold-plated, diamond-studded King",
      ...
      $http.jsonp('http://localhost:3000/product_list').success(function(data,status,header){
        $scope.products_object=data;
        console.log(data);
